...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(20, 10, 741, 291))
        ...
        self.gridLayout.addWidget(self.line_car_id, 1, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.Button_create_allocation, 0, 1, 1, 1)
